      ...
      <div>
        <form className="pl" action={"/card_templates/" + this.props.template.id +"/cards"} method="post">
          ...
          <div className="form-group">
            ...
            <input className="form-control" id="custom_message" name="custom_message" type="textarea"></input>
          </div>
          ...
          <div className="form-group">
            ...
            <input className="form-control" id="recipient_name" name="recipient_name" type="text"></input>
          </div>

          <div className="form-group">
            <label htmlFor="street_address">Street Address</label>
            <input className="form-control" id="street_address" name="street_address" type="text"></input>
          </div>

          <div className="form-group">
            <label htmlFor="city">City</label>
            <input className="form-control" id="city" name="city" type="text"></input>
          </div>

          <div className="form-group">
            <label htmlFor="state">State</label>
            <input className="form-control" id="state" name="state" type="text"></input>
          </div>

          <div className="form-group">
            <label htmlFor="zip_code">Zip Code</label>
            <input className="form-control" id="zip_code" name="zip_code" type="text"></input>
          </div>
